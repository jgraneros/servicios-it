...
public class Solicitud implements Serializable {
    ...
    @JsonIgnoreProperties(value = { "soliictud" }, allowSetters = true)
    @OneToOne(fetch = FetchType.LAZY, mappedBy = "soliictud")
    ...
    public void setServicio(Servicio servicio) {
        if (this.servicio != null) {
            this.servicio.setSoliictud(null);
        }
        if (servicio != null) {
            servicio.setSoliictud(this);
        }
