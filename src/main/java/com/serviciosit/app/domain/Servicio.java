...
public class Servicio implements Serializable {
    ...
    public Solicitud getSoliictud() {
        return this.soliictud;
    }

    public void setSoliictud(Solicitud solicitud) {
        this.soliictud = solicitud;
    }

    public Servicio soliictud(Solicitud solicitud) {
        this.setSoliictud(solicitud);
        return this;
    }
