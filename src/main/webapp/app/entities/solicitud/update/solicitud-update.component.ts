...
export class SolicitudUpdateComponent implements OnInit {
  ...
  protected updateForm(solicitud: ISolicitud): void {
    ...
    this.usersSharedCollection = this.userService.addUserToCollectionIfMissing<IUser>(this.usersSharedCollection, solicitud.usuario);
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.userService
      ...
      .pipe(map((users: IUser[]) => this.userService.addUserToCollectionIfMissing<IUser>(users, this.solicitud?.usuario)))
