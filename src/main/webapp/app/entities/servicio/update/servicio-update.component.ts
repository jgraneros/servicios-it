...
export class ServicioUpdateComponent implements OnInit {
  ...
  solicitudsCollection: ISolicitud[] = [];
  ...
  protected updateForm(servicio: IServicio): void {
    ...
    this.solicitudsCollection = this.solicitudService.addSolicitudToCollectionIfMissing<ISolicitud>(
      this.solicitudsCollection,
      servicio.solicitud,
    );
  }
    ...
    this.solicitudService
      ...
      .pipe(
        map((solicituds: ISolicitud[]) =>
          this.solicitudService.addSolicitudToCollectionIfMissing<ISolicitud>(solicituds, this.servicio?.solicitud),
        ),
      )
      .subscribe((solicituds: ISolicitud[]) => (this.solicitudsCollection = solicituds));
  }
}
